...
<body>
	<ul class="topnav">
        ...
        <div class="card">
            ...
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            <span class="downloads"><?php echo $row["purchases"]?> Purchases</span>
            <br><br><br>
			<a href="pay.php">
			<button type="submit" class="buy"><div>Buy game : ₹ <?php echo $row["price"]?></div></button>
			</a>
		&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; 
			...
			while($srow = mysqli_fetch_assoc($sresult))
			{
				...
				{	
					echo "<form action = '#' method = 'post' class = 'buyform'>
						<input type = 'submit' class = 'buy' name = 'cd' value ='Buy CD : ₹".$row['price']."'>
						</form>
					";
					// echo "<a href='pay.php'><button class='buy'  name = 'cd' method = 'post'><div>Buy CD : ₹".$row["price"]."</div></button></a>";					
				}
			?>
        </div>  
		<div class="footer">
